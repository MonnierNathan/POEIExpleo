...
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk_0 }];#set
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 4} [get_ports { clk_0 }];#set

# RGB LEDs
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { blue_led_0 }]; #IO_L22N_T3_AD7N_35 Sch=led0_b
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { green_led_0 }]; #IO_L16P_T2_35 Sch=led0_g
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { red_led_0 }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led0_r
...
# Buttons
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { resetn_0 }]; #IO_L4N_T0_35 Sch=btn[0]
