...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports Clk_0]
...
# Buttons
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports B0]
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports B1]
...
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports Reset_0]
